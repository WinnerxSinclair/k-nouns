<template>
  <div class="flex edit-card-wrap col ac" v-if="!loading && form">
    <RouterLink aria-label="Back to Dashboard" class="back-btn" :to="{path: '/dashboard', replace: true }">
    ...
    <form @submit.prevent="saveEntry" > 
      ...
      <section class="flex col gap">
        <div class="flex gap ac mt-3">
          ...
          >
          <button aria-label="Add Tag" class="arrow-btn" type="button" @click="handleAddTagClick(tagInput)" :disabled="submitting">
